      ...
      <Container className="relative z-10 flex h-full flex-col justify-center py-16 sm:py-20 lg:py-24">
        <div className="grid w-full items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <h2 className="mt-3.5 text-balance font-black leading-[1.1] tracking-tight text-ink text-[clamp(1.9rem,1.2rem+2.8vw,2.5rem)]">
              Hành trình xây dựng
              <br />
              <span className="text-gradient italic">Kỷ nguyên Việt Nam</span>
            </h2>
            <p className="mt-3.5 max-w-lg text-[15px] leading-7 text-muted">
              Câu chuyện về 5 công ty, 14 nền tảng số và tầm nhìn dài hạn của VEA Group — bắt nguồn từ tình yêu và
              khát vọng cống hiến cho đất nước.
            </p>
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Button href="/ve-vea/cau-chuyen" size="lg">
                Đọc câu chuyện của chúng tôi <ArrowRight className="h-4 w-4" />
              </Button>
          ...
          <Link
            ...
            aria-label="Xem câu chuyện VEA Group"
          ...
          >
            <span className="absolute inset-0 flex flex-col items-center justify-center gap-3.5">
              ...
              <span className="text-[13px] font-medium text-white/70">Xem câu chuyện VEA Group</span>
            </span>
